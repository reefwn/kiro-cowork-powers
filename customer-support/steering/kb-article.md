...
- **~~support platform**: Pull the ticket thread, resolution, and internal notes
- **~~knowledge base**: Check if a similar article already exists
...
- Follow the template for the chosen article type
- Apply searchability best practices: customer-language title, plain-language opening, exact error messages, common synonyms
...
[Full article content — using the appropriate template from the knowledge-management skill]
...
- "Want me to draft a companion article?"
