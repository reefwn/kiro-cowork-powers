...
│ ✓ Provide new hire details and get a full onboarding plan       │
│ ✓ Pre-start checklist, Day 1 schedule, Week 1 tasks             │
│ ✓ 30/60/90-day goals and key contacts                           │
├─────────────────────────────────────────────────────────────────┤
│ SUPERCHARGED (when you connect your tools)                      │
│ + HRIS: Pull new hire details and org chart                     │
│ + Knowledge base: Link to onboarding docs and wikis             │
│ + Calendar: Create Day 1 events and Week 1 invites              │
└─────────────────────────────────────────────────────────────────┘
```
